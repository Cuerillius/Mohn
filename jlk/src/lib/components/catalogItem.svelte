...
<div class="group relative shrink-0">
  ...
  >
    ...
    <p
      class="wrap-break-words line-clamp-5 px-4 pt-2 text-left text-sm text-gray-500"
    >
      {entry.description}
    </p>
    ...
    <div class="flex gap-2 p-4 pt-3">
      ...
      >
      <div
        class="flex w-full flex-col items-center justify-center text-sm text-gray-500"
      >
        <div class="flex">
          <p>
            {type}
  ...
  <div class="relative w-48 shrink-0">
    <a href="/meta/{entry.type}/{id}">
      ...
      {#if entry.inLibrary}
        <Badge
          variant="outline"
          class="absolute top-2 left-2 h-7 backdrop-blur-lg"
